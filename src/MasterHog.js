    ...
    return (
      <div>
        ...
        <ul className="hoglist">
          <BabyHog eyeColor={this.state.eyeColor} babyData={offspring[0]}/>
          <BabyHog eyeColor={this.state.eyeColor}babyData={offspring[1]}/>
          <BabyHog eyeColor={this.state.eyeColor}babyData={offspring[2]}/>
        </ul>
